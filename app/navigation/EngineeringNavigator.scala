...
class EngineeringNavigator @Inject() () extends Navigator {
  ...
  protected val routeMap: PartialFunction[Page, UserAnswers => Call] = {
    ...
    case ConstructionalEngineeringList3Page =>
      _ => controllers.routes.EmployerContributionController.onPageLoad(NormalMode)
  ...
  protected val checkRouteMap: PartialFunction[Page, UserAnswers => Call] = {
    ...
    case ConstructionalEngineeringList3Page =>
      _ => controllers.routes.EmployerContributionController.onPageLoad(CheckMode)
