...
class AuthenticatedSessionRepository @Inject()(
                                        ...
                                        )(implicit ec: ExecutionContext, m: Materializer) extends AuthedSessionRepository {


  private val collectionName: String = "authed-user-answers"
  ...
  private val lastUpdatedIndex = Index(
    ...
    name    = Some("authed-user-answers-last-updated-index"),
