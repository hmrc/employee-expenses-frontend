...
class CitizenDetailsConnectorImpl @Inject() (appConfig: FrontendAppConfig, httpClient: HttpClientV2)
  ...
  override def getEtag(nino: String)(using HeaderCarrier, ExecutionContext): Future[HttpResponse] = {
  ...
  override def getAddress(nino: String)(using HeaderCarrier, ExecutionContext): Future[HttpResponse] = {
...
trait CitizenDetailsConnector {
  def getEtag(nino: String)(using HeaderCarrier, ExecutionContext): Future[HttpResponse]
