...
class SecondIndustryOptionsViewSpec extends ViewBehaviours {
  ...
  "SecondIndustryOptionsView" when {
    ...
    "rendered" must {
      ...
      "contain radio buttons for the value" in {
        ...
        for (option <- SecondIndustryOptions.options) {
    ...
    for (option <- SecondIndustryOptions.options) {
      ...
      s"rendered with a value of '${option.value}'" must {
        ...
        s"have the '${option.value}' radio button selected" in {
          ...
          for (unselectedOption <- SecondIndustryOptions.options.filterNot(o => o == option)) {
