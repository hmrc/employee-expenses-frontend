...
class TextilesOccupationList1ControllerSpec
    extends SpecBase
    with ScalaFutures
  ...
  "TextilesOccupationList1 Controller" must {
    ...
    "save 'textiles.list1' to ClaimAmount when 'Yes' is selected" in {
      ...
      val ua2 =
        ua1
          .set(ClaimAmount, ClaimAmounts.Textiles.list1)
          .success
          .value
          .set(TextilesOccupationList1Page, true)
          .success
          .value
    ...
    "save 'textiles.allOther' to ClaimAmount when 'No' is selected" in {
      ...
      val ua2 =
        ua1
          .set(ClaimAmount, ClaimAmounts.Textiles.allOther)
          .success
          .value
          .set(TextilesOccupationList1Page, false)
          .success
          .value
