...
class ShipyardOccupationList1ControllerSpec
    extends SpecBase
    with ScalaFutures
  ...
  "ShipyardOccupationList1 Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers().set(ShipyardOccupationList1Page, true).success.value
    ...
    "save 'list1' to ClaimAmount when 'Yes' is selected" in {
      ...
      val ua2 =
        ua1
          .set(ClaimAmount, ClaimAmounts.Shipyard.list1)
          .success
          .value
          .set(ShipyardOccupationList1Page, true)
          .success
          .value
