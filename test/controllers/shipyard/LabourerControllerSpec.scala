...
class LabourerControllerSpec
  ...
  lazy val labourerRoute: String = routes.LabourerController.onPageLoad(NormalMode).url
  ...
  "Labourer Controller" must {
    ...
    "save correct ClaimAmount when 'Yes' is selected" in {
      ...
      val ua2 =
        ua1
          .set(ClaimAmount, ClaimAmounts.Shipyard.labourer)
          .success
          .value
          .set(LabourerPage, true)
          .success
          .value
    ...
    "save correct ClaimAmount when 'No' is selected" in {
      ...
      val ua2 = ua1
        .set(ClaimAmount, ClaimAmounts.Shipyard.allOther)
        .success
        .value
        .set(LabourerPage, false)
        .success
        .value
