...
class AluminiumOccupationList3ControllerSpec extends SpecBase with ScalaFutures {
  ...
  "AluminiumOccupationList3 Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AluminiumOccupationList3Page, true).success.value
