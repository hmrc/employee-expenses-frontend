...
class IronSteelOccupationListControllerSpec
    extends SpecBase
    with ScalaFutures
    with MockitoSugar
  ...
  lazy val ironSteelOccupationListRoute: String = routes.IronSteelOccupationListController.onPageLoad(NormalMode).url
  ...
  "IronSteelOccupationList Controller" must {
    ...
    "return OK for a GET" in {
      ...
      val request = FakeRequest(GET, ironSteelOccupationListRoute)
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers().set(IronSteelOccupationListPage, true).success.value
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, ironSteelOccupationListRoute)
    ...
    "save 'list1' to ClaimAmount when 'Yes' is selected" in {
      ...
      val userAnswers2 = userAnswers
        .set(ClaimAmount, ClaimAmounts.Manufacturing.IronSteel.list1)
        .success
        .value
        .set(IronSteelOccupationListPage, true)
        .success
        .value
    ...
    "save 'default' to ClaimAmount when 'No' is selected" in {
      ...
      val userAnswers2 = userAnswers
        ...
        .success
        .value
        .set(IronSteelOccupationListPage, false)
        .success
        .value
