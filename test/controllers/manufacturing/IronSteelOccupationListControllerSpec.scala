...
class IronSteelOccupationListControllerSpec extends SpecBase with ScalaFutures with IntegrationPatience {

  def onwardRoute = Call("GET", "/foo")

  val formProvider = new IronSteelOccupationListFormProvider()
