...
class FactoryEngineeringList2ControllerSpec
    extends SpecBase
    with MockitoSugar
    with ScalaFutures
  ...
  "FactoryEngineeringList2 Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers().set(FactoryEngineeringList2Page, true).success.value
    ...
    "save ClaimAmount when 'Yes' is selected" in {
      ...
      val userAnswers2 = userAnswers
        .set(ClaimAmount, ClaimAmounts.FactoryEngineering.list2)
        .success
        .value
        .set(FactoryEngineeringList2Page, true)
        .success
        .value
