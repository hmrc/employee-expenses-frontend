  ...
  "ConstructionalEngineeringList2 Controller" must {
    ...
    "save 'list2' to ClaimAmount when 'Yes' is selected" in {
      ...
      val userAnswers2 = userAnswers
        .set(ClaimAmount, ClaimAmounts.ConstructionalEngineering.list2).success.value
        .set(ConstructionalEngineeringList2Page, true).success.value
    ...
    "save no ClaimAmount when 'No' is selected" in {
      ...
      val userAnswers2 = userAnswers
        .set(ConstructionalEngineeringList2Page, false).success.value
