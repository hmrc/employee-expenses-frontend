...
class MetropolitanPoliceControllerSpec
    extends SpecBase
    with ScalaFutures
    with MockitoSugar
  ...
  "MetropolitanPolice Controller" must {
    ...
    "return OK for a GET" in {
      ...
      val request = FakeRequest(GET, metropolitanPoliceRoute)
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers().set(MetropolitanPolicePage, true).success.value
    ...
    "redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, metropolitanPoliceRoute)
    ...
    "save no ClaimAmount when 'Yes' is selected" in {
      ...
      val userAnswers2 = userAnswers
        .set(MetropolitanPolicePage, true)
        .success
        .value
    ...
    "save no ClaimAmount when 'No' is selected" in {
      ...
      val userAnswers2 = userAnswers
        .set(MetropolitanPolicePage, false)
        .success
        .value
