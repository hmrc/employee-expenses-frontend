...
class SecondIndustryOptionsSpec extends AnyWordSpec with Matchers with ScalaCheckPropertyChecks with OptionValues {
  ...
  "SecondIndustryOptions" must {
    ...
    "deserialise valid values" in {
      ...
      forAll(gen) { secondIndustryOptions =>
        JsString(secondIndustryOptions.toString)
          .validate[SecondIndustryOptions]
          .asOpt
          .value mustEqual secondIndustryOptions
      }
    }
